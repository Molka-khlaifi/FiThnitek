...
public class VehiculeService implements IService<Vehicule> {
    ...
    private Vehicule mapVehicule(ResultSet resultSet) throws SQLException {
        ...
        vehicule.setIdVehicule(getInt(resultSet, "id_vehicule", "idVehicule"));
        vehicule.setIdUtilisateur(getInt(resultSet, "id_utilisateur", "idUtilisateur"));
        vehicule.setMarque(getString(resultSet, "marque"));
        vehicule.setModele(getString(resultSet, "modele"));
        vehicule.setImmatriculation(getString(resultSet, "immatriculation"));
        vehicule.setCouleur(getString(resultSet, "couleur"));
        vehicule.setAnnee(getInt(resultSet, "annee"));
        vehicule.setNombrePlaces(getInt(resultSet, "nombre_places", "nombrePlaces"));
        vehicule.setTypeVehicule(getString(resultSet, "type_vehicule", "typeVehicule"));
        vehicule.setEnergie(getString(resultSet, "energie"));
        vehicule.setPhotoPath(getString(resultSet, "photo_path", "photoPath"));
        vehicule.setStatut(getString(resultSet, "statut"));
        vehicule.setStatutValidation(getString(resultSet, "statut_validation", "statutValidation"));

        return vehicule;
    }

    private int getInt(ResultSet resultSet, String... columns) throws SQLException {
    ...
    private String getString(ResultSet resultSet, String... columns) throws SQLException {
        for (String column : columns) {
            if (hasColumn(resultSet, column)) {
