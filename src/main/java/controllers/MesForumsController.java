...
public class MesForumsController {
    ...
    private void afficherFeed(List<publication> list) {
        ...
        for (publication post : list) {
            ...
            if (categorie == null || categorie.isBlank()) categorie = "NON DÉFINIE";
            ...
            // ── Empêcher propagation sur les boutons ──
    ...
    private void modifierPost(publication post) {
        try {
            ...
            // ✅ Rester dans le conteneur FORUM du dashboard
    ...
    @FXML void ajouterAction(ActionEvent event)      { NavigationManager.navigateInTab("FORUM", "/AjouterForum.fxml");  }
    @FXML void retourListeAction(ActionEvent event)  { NavigationManager.navigateInTab("FORUM", "/ListeForum.fxml");    }
    @FXML void openActiviteAction(ActionEvent event) { NavigationManager.navigateInTab("FORUM", "/MonActivite.fxml");   }
