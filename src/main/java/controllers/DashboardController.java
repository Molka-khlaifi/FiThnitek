...
public class DashboardController implements Initializable {
    ...
    @FXML
    private void showReservations()  { loadPage("reservationTrajet",  "Réservations"); }

    @FXML
    private void showMap()           { loadPage("MapTrajet",          "Carte des Trajets"); }

    @FXML
    private void showStats()         { loadPage("StatistiquesTrajet", "Statistiques & Analyses"); }
